  ...
  function setButtonIcon(schema) {
    if (validColorSchemaKeys[schema]) {
      ...
      if(window.VANTA){
        ...
        let schemaFog = document.documentElement.getAttribute('data-user-color-scheme') === 'light';
        window.VANTA.current.options.highlightColor = schemaFog?0xf76262:'#cdcdcd'
        window.VANTA.current.options.midtoneColor = schemaFog?0xf76262:'#363e4d'
        window.VANTA.current.options.baseColor = schemaFog?0xffffff:'#272f3f'
        window.VANTA.current.restart()
